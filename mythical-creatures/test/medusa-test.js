...
describe('Medusa', function() {
  ...
  it('should instantiate our good friend, Medusa', function() {
    var derek = new Medusa();

    assert.instanceOf(derek, Medusa);
  });

  it('should have a name', function() {
    var medusa1 = new Medusa('derek');
    var medusa2 = new Medusa('masha');

    assert.equal(medusa1.name, 'derek');
    assert.equal(medusa2.name, 'masha');
